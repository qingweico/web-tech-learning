...
public class ConvertUtil {
     ...
     * 转换方法引用为属性名
     */
    public static <T> String convertToFieldName(InterFunction<T, ?> fn) {
        ...
        try {
            String fieldMeta = StringUtils.uncapitalize(methodName);
    ...
    public static void main(String[] args) {
        System.out.println(StringUtils.uncapitalize("Java"));
    }
}
