        ...
        <a-row :gutter="24">
          ...
          <a-col :md="8" :sm="10">
            <a-form-item label="创建时间" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-range-picker
                style="width: 210px"
                v-model="queryParam.CreatedRange"
                format="YYYY-MM-DD"
...
<script>
  ...
  export default {
    ...
    methods: {
      getQueryParams(){
        console.log(this.queryParam.CreatedRange)
      ...
      onDateChange: function (value, dateString) {
        this.queryParam.Created_begin=dateString[0];
        this.queryParam.Created_end=dateString[1];
      },
      onDateOk(value) {
        // console.log(value);
      },
