  ...
  <a-row :gutter="10">
    ...
    <a-col :md="rightColMd" :sm="24">
      <a-card :bordered="false">
              ...
              <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
                <a-col :md="9" :sm="24">
                  <a-button
                    ...
                    style="margin-left: 21px"
                  >查询</a-button>
                   <a-button @click="handleAdd2" type="primary" icon="plus" style="margin-left: 8px">用户录入</a-button>
                </a-col>
              </span>
            </a-row>
          </a-form>
        ...
        <!-- 操作按钮区域 -->
        <!-- <div class="table-operator" :md="24" :sm="24" style="height: 32px;margin: 25px 0px 10px 2px"> -->
  ...
  data() {
    return {
      ...
      url: {
        ...
        exportXlsTmplUrl: 'sys/role/exportXlsTemplate'
      }
    }
  },
  computed: {
  ...
  methods: {
    ...
    handleAddUserRole() {
      if (this.currentRoleId == '') {
        ...
        this.$refs.selectUserModal.init()
      }
    },
    handleOpen(record) {
