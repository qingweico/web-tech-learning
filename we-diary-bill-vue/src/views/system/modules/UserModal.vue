    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="角色分配" :labelCol="labelCol" :wrapperCol="wrapperCol" v-show="!roleDisabled">
          ...
          <a-select placeholder="请选择用户角色"  style="width: 100%" v-model="selectedRole"  v-decorator="[ 'roleList', validatorRules.roleList]">
            <a-select-option
        ...
        <!-- <a-form-item label="手持端登录权限" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-select v-decorator="[ 'signMobile', {}]" placeholder="否">
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        ...
        roleList: {rules: [{required: true, message: '请输入用户角色!'}]},
  ...
  methods: {
    ...
    edit(record) {
      ...
      that.$nextTick(() => {
        that.form.setFieldsValue(pick(this.model, 'username', 'sex', 'realname', 'email', 'phone', 'activitiSync', 'signMobile'))
      });
      // 调用查询用户对应的部门信息的方法
