...
// 获取车道tree
const queryTreeListForArm = (params)=>getAction("/parking/parkArmInfo/getArmList",params);

// 获取已有的监控车道
const queryTreeListForHasArm = (params)=>getAction("/parking/parkArmInfo/getArmListByMac",params);
// 保存监控车道
const saveArm = (params)=>postAction("/parking/parkArmInfo/saveArm",params);
...
//车辆类型
const getCarTypeList = (params)=>getAction("/ConfigCarType/configCarType/carTypeList",params);
...
const getDataInfo = (params)=>getAction("/openaccountepaydaystatistical/statisticalByMonth",params);
//数据日志访问
...
//查询车场和车道信息树
const getPackArmInfoTree = (params)=>getAction("/equipment/deviceSeatAnswer/getPackArmInfoTree",params);
...
//查询新版月租车车场信息
const getMonthlyParkInfoList = (params)=>getAction("/parking/parkInfo/monthlyParkInfoList",params);

// 查询月套餐信息
const getMonthlyPackageInfo =  (params)=>getAction("/monthlyPackageInfo/monthlyPackageInfoList",params);


export {
  getMonthlyParkInfoList,
  getMonthlyPackageInfo,
  addRole,
  getCarTypeList,
  editRole,
  checkRoleCode,
