...
import cn.qingweico.modules.system.entity.SysDepart;
import lombok.Data;
...
public class SysDepartTreeModel implements Serializable {
    ...
    public SysDepartTreeModel(SysDepart sysDepart) {
        ...
        this.createdBy = sysDepart.getCreatedBy();
        this.created = sysDepart.getCreated();
        this.lastUpdBy = sysDepart.getLastUpdBy();
        this.lastUpd = sysDepart.getLastUpd();
    }
