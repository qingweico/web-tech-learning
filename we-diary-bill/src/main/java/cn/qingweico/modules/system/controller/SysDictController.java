...
import cn.qingweico.modules.system.model.SysDictTree;
...
import cn.qingweico.modules.system.vo.SysDictPage;
...
public class SysDictController {
	...
	public Result<List<SysDictTree>> treeList(SysDict sysDict, @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
		...
		query.orderByDesc(true, SysDict::getCreated);
