...
public class ExportParams extends ExcelBaseParams {
    ...
    public ExportParams(String title, short titleHeight, String secondTitle, short secondTitleHeight, String sheetName, String[] exclusions, boolean addIndex, String indexName, int freezeCol, short color, short headerColor, ExcelType type, Class<?> style, double headerHeight, boolean isCreateHeadRows, boolean isDynamicData, boolean isAppendGraph, boolean isFixedTitle, int maxNum, short height) {
        this.title = title;
