package cn.qingweico.common.util.excel.html;

import cn.qingweico.common.util.excel.export.styler.ExcelExportStylerDefaultImpl;
import cn.qingweico.common.util.excel.html.css.CssParseService;
import cn.qingweico.common.util.excel.html.css.ICssConvertToExcel;
import cn.qingweico.common.util.excel.html.css.impl.*;
import cn.qingweico.common.util.excel.html.entity.ExcelCssConstant;
import cn.qingweico.common.util.excel.html.entity.HtmlCssConstant;
...
public class HtmlToExcelService {
    ...
    public Workbook createSheet(String html, Workbook workbook) {
        ...
        Map<String, Sheet> sheets = new HashMap<>(16);
        Map<String, Integer> maxrowMap = new HashMap<>(16);
