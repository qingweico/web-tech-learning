 ...
 */
package cn.qingweico.common.util.excel.export.base;
...
import cn.qingweico.common.util.excel.vo.PoiBaseConstants;
...
public class ExportCommonService {
     ...
     * 创建导出实体对象
     */
    public ExcelExportEntity createExcelExportEntity(Field field, String targetId,
                                                      Class<?> pojoClass,
     ...
     * 注解到导出对象的转换
     */
    public void getExcelField(String targetId, Field field, ExcelExportEntity excelEntity,
    ...
    public void sortAllParams(List<ExcelExportEntity> excelParams) {
        ...
        Map<String, List<ExcelExportEntity>> groupMap = new HashMap<>(16);
