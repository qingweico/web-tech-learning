package cn.qingweico.common.util.excel.service;

import cn.qingweico.common.util.excel.annotation.Excel;
import cn.qingweico.common.util.excel.annotation.ExcelCollection;
import cn.qingweico.common.util.excel.annotation.ExcelEntity;
...
public class ImportBaseService {
    ...
    public void addEntityToMap(String targetId, Field field, ExcelImportEntity excelEntity,
        ...
        excelEntity.setImportField(Boolean.valueOf(excel.isImportField()));
    ...
    public void getAllExcelField(String targetId, Field[] fields,
                                 ...
                                 List<Method> getMethods, ExcelEntity excelEntityAnn) throws Exception, ExcelImportException {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            if (PoiPublicUtil.isCollection(field.getType())) {
                ...
                Map<String, ExcelImportEntity> temp = new HashMap<>(16);
