package cn.qingweico.common.util.excel.service.impl;

import cn.qingweico.common.util.excel.annotation.ExcelTarget;
import cn.qingweico.common.util.excel.entity.ExcelCollectionParams;
import cn.qingweico.common.util.excel.entity.ExcelImportEntity;
import cn.qingweico.common.util.excel.entity.enums.ExcelImportEnum;
...
import cn.qingweico.common.util.excel.entity.result.ExcelVerifyHandlerResult;
import cn.qingweico.common.util.excel.exception.ExcelImportException;
import cn.qingweico.common.util.excel.handler.IExcelDataModel;
import cn.qingweico.common.util.excel.handler.IExcelModel;
import cn.qingweico.common.util.excel.imports.CellValueService;
import cn.qingweico.common.util.excel.imports.recursive.ExcelImportForkJoinWork;
import cn.qingweico.common.util.excel.service.ImportBaseService;
import cn.qingweico.common.util.excel.util.PoiCellUtil;
import cn.qingweico.common.util.excel.util.PoiPublicUtil;
import cn.qingweico.common.util.excel.util.PoiReflectorUtil;
import cn.qingweico.common.util.excel.util.PoiValidationUtil;
...
public class ExcelImportService extends ImportBaseService {
    ...
    private <T> List<T> importExcel(Collection<T> result, Sheet sheet, Class<?> pojoClass,
                                    ImportParams params,
                                    Map<String, PictureData> pictures) throws Exception, ExcelImportException {
        List collection = new ArrayList();
        Map<String, ExcelImportEntity> excelParams = new HashMap<>(16);
    ...
    private void readSingleCell(ExcelImportResult result, Sheet sheet, ImportParams params) {
        if (result.getMap() == null) {
            result.setMap(new HashMap<String, Object>(16));
        }
    ...
    private void checkIsValidTemplate(Map<Integer, String> titlemap,
                                      Map<String, ExcelImportEntity> excelParams,
                                      ImportParams params,
                                      List<ExcelCollectionParams> excelCollection) throws ExcelImportException {
