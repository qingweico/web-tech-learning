...
public class QRCodeUtil {
    ...
    public static void insertImageFor(BufferedImage source, String imgPath,
     ...
     * @param destUrl 目的地地址
     */
    public static void saveToFile(String srcUrl, String destUrl) {
...
//        String file = new Random().nextInt(99999999)+".jpg";
    ...
    public static void main(String[] args) throws Exception {
        ...
        //二维码URL生成
        QRCodeUtil.encode("1212632748263768066&3"
                , "F:/y/icbc/1212632748263768066.png", true);
