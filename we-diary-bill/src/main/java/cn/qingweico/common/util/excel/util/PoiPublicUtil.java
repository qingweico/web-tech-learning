 ...
 */
package cn.qingweico.common.util.excel.util;
...
import cn.qingweico.common.util.excel.annotation.ExcelIgnore;
import cn.qingweico.common.util.excel.cache.ImageCache;
import cn.qingweico.common.util.excel.entity.ImageEntity;
import cn.qingweico.common.util.excel.entity.params.ExcelListEntity;
...
import static cn.qingweico.common.util.excel.util.PoiElUtil.END_STR;
import static cn.qingweico.common.util.excel.util.PoiElUtil.START_STR;
...
public final class PoiPublicUtil {
        ...
        if (!pictures.isEmpty()) {
            for (HSSFShape shape : sheet.getDrawingPatriarch().getChildren()) {
                ...
                if (shape instanceof HSSFPicture) {
                    ...
                    String picIndex = anchor.getRow1() + "_"
    ...
    public static boolean isNotUserExcelUserThis(List<String> exclusionsList, Field field,
                                                 String targetId) {
        boolean boo = true;
        if (field.getAnnotation(ExcelIgnore.class) != null || (!CollectionUtils.isEmpty(exclusionsList) && exclusionsList.contains(field.getName()))) {
            boo = true;
